...
Indexed DD/DN half spectra, immutable shared pole tables, raw K versus SKS sectors and H/E fields are repaired. Correct n2 normalized Green formulas and rank-one criterion are in analytic-repair.md and three current cards. All five final stateless reviews passed after preserving a software CHANGES_REQUIRED and formal-readback INCOMPLETE. Current library22 obligations/8 cards,90 available/1 original withdrawn,3 exact annotations verified through original APIs. No new mathematical card was added. Local Lean59 declarations establish finite real matrix/coordinate/normalization identities only; no complete Green/ODE/Python/inertia or interval certification.
