...
2026-09-21第六轮: 只续接上游谱域/左定尺度依赖的精确版本. 第五轮两迹证明及其s=2余有限分类保持原文和适用范围; 全族的0<=s<7/2补证不能自动扩大本卡的删除分类到其它s.
