...
run_cmd do
  ...
  IO.FS.writeFile "F:\\tools\\math-audit-round7-20260921\\independent-execution-v2\\lean-package\\fresh-independent-20260921T122826Z-27cdbba98232\\public-declarations.json" ((Json.arr Results).pretty ++ "\n")
