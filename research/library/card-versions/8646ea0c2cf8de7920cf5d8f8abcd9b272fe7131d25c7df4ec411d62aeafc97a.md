---
{"author_ids": ["coordinator-20260920-round3"], "created": "2026-08-05", "evidence_status": "ANALYTIC_PROOF_SCOPED", "scope": "Both parity recurrences; product equality only for B=Bprime=0; formal polynomial images distinguished from Krein domain.", "source": "自研 (会话 11, 方向 3)", "sources": [{"locator": "thm:growth, thm:exact, thm:sharp, thm:line, thm:margin, prop:perturb-counter", "path": "docs/SL_stability_moment_jump.tex", "sha256": "f77079f053c7d22a03ae5dffc38f092fb9b532c92345256582a96d2d41f03c45"}], "status": "第三轮解析修订; 可复用状态见纠错记录", "tags": ["mathtool", "self-developed", "completeness", "moments", "stability"], "title": "矩跳跃的条件稳定性: 实际递推与 B=0 模型", "tool_id": "jump-stability"}
---
# 矩跳跃的条件稳定性
