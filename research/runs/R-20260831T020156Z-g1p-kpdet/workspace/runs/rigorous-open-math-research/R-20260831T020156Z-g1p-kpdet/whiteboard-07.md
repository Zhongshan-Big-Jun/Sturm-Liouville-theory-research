...
The sequence-07 joint audit returned `REPAIRABLE_GAP`. W4 and the exact W5
mass-defective witness are accepted strict partial results. The W5 restricted
near-one theorem is downgraded until its moving-switch compactness argument is
written explicitly. Seal this segment before any repair or solver response.
