...
Out = Path('F:/tools/math-audit-round10-20260925')
...
Command = [str(Bin / 'python3.12.exe'), '-B', '-I', '-S', '-X', 'utf8', '-X', 'pycache_prefix=/mnt/f/tools/math-audit-round10-20260925/unused-pycache', *sys.argv[1:]]
