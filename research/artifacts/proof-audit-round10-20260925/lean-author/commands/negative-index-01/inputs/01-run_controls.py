...
PLANS = [
	('positive-refutations-02', 'Counterexamples.lean', 0, []),
	...
	('print-controls-01', 'PrintCounterexamples.lean', 0, ['positive-refutations-02']),
	('explicit-export-01', 'ReadbackExport.lean', 0, []),
]
OBSERVED = json.loads((BASE / 'control-execution.json').read_text()) if (BASE / 'control-execution.json').is_file() else []
