...
if __name__ == '__main__':
	...
	if Mode == 'version':
		...
		Source = PROJECT / (sys.argv[3] if len(sys.argv) > 3 else 'AuditRound10.lean')
		...
		Result = run(Label, [sys.executable, '-B', PLUGIN / 'scripts/verify_lean_project.py', '--project', PROJECT,
			...
			'--output', BASE / 'evidence' / Label], Inputs=[Contract, PROJECT / 'AuditRound10.lean', PROJECT / 'lean-toolchain'])
	else:
