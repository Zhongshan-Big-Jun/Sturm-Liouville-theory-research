...
theorem Reviewer.literal_root :
(∀ {n : ℕ} (u v : AuditRound10.Vec n) (a : ℝ),
...
#lean_verify_v2 AuditRound10.root expected Reviewer.literal_root output "F:\\tools\\math-audit-round10-20260925\\formal-reviewer\\independent-35c0ed5b7a9f\\evidence\\root-inspection.json"
