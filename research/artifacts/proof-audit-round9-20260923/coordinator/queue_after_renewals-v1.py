...
for Mode,Name in [('receive','software-review'),('receive','math-review2'),('prepare','formal-readback')]:
...
print('Renewals finished; both actual completions received; formal blind packet ready.',flush=True)
