...
O=Path('/mnt/f/tools/math-audit-round11-20260926');R=Path('/mnt/f/LaTeX/BVE research')
Native=['/mnt/c/Users/HuangZY/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/python.exe','F:/tools/math-audit-round11-20260926/run_native_posix.py']
...
for Name,Script in [('release-current-final','release_current_final.py'),('index-library','index_library.py'),('query-library','query_library.py')]:
    Log=O/(Name+'.log')
