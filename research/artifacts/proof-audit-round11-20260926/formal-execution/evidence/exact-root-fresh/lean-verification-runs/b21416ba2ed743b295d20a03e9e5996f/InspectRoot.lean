...
axiom LeanVerifyV2.expected_statement : open scoped Matrix in ((∀ (n : ℕ),
...
(∀ (L : ℕ) (h : 4 ≤ L),
  0 < (AuditRound11.boundary_full (L : ℝ)).det ∧
    (∀ b : AuditRound11.PairIndex 2 → ℝ, ∃! a : AuditRound11.PairIndex 2 → ℝ,
      AuditRound11.boundary_full (L : ℝ) *ᵥ a = b)))
#lean_verify_v2 AuditRound11.root expected LeanVerifyV2.expected_statement output "F:\\tools\\math-audit-round11-20260926\\formal-reviewer\\stateless-a8e81148d09f\\evidence\\exact-root-fresh\\lean-verification-runs\\b21416ba2ed743b295d20a03e9e5996f\\declaration.json"
