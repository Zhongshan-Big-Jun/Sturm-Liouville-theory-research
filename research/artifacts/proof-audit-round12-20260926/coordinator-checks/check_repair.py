...
ExtremeTable = Half.half_spectrum([(1.0,1e-306)], 'D', 4, return_table=True)
rejects('spectral-denominator-overflow', lambda: Half._spectral_full_green([(1.0,1e-306)], -np.finfo(float).max, 'D', 0.25, 0.25, 4, spectrum=ExtremeTable))
