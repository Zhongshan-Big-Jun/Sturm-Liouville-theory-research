...
ArchiveCount = 0
for Name in ['lean-author-archive-manifest.json', 'formal-export2-archive-manifest.json', 'formal-execution-archive-manifest.json', 'coordinator-archive-manifest.json', 'integration/archive-manifest.json', 'integration/document-check-repair/manifest.json']:
