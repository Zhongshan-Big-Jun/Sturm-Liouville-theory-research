...
Out = Path('F:/tools/math-audit-round12-20260926')
...
Command = [str(Bin / 'python3.12.exe'), '-B', '-I', '-S', '-X', 'utf8', '-X', 'pycache_prefix=/mnt/f/tools/math-audit-round12-20260926/unused-pycache', *sys.argv[1:]]
