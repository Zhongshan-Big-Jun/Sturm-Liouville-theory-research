...
Project = Root / 'research/artifacts/proof-audit-round12-20260926/software-review2'
...
Read only this frozen packet, not repository history, memory or prior verdicts. Use standard installed Python scientific libraries. Copy all inputs to a new directory under /mnt/f/tools/math-audit-round12-20260926/software-review2er; use that directory as cwd and record its identity. Examine source before running. Do not write main repository or frozen inputs. No full historical scans.
...
for Name, Data in [('software-review2-spec.json', Spec), ('software-review2-packet.json', Review.create_packet(Project, Spec)), ('software-review2-root.json', dict(project=str(Project)))]:
