...
Source = Out / 'formal-export2/blind'
Project = Root / 'research/artifacts/proof-audit-round12-20260926/formal-readback2'
...
for Name, Data in [('formal-readback2-spec.json',Spec),('formal-readback2-root.json',dict(project=str(Project))),('formal-readback2-packet.json',Review.create_packet(Project,Spec))]:
