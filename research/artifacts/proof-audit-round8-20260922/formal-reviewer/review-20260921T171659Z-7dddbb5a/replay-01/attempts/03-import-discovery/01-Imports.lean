...
run_cmd do
  ...
  IO.FS.writeFile "F:\\tools\\math-audit-round8-20260922\\formal-reviewer\\review-20260921T171659Z-7dddbb5a\\replay-01\\import-discovery.json" ((Json.arr rows).compress ++ "\n")
