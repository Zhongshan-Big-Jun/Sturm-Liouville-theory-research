...
def main():
	...
	write_json(BASE / 'protection-check.json', dict(protected_count=len(Before), changed_paths=Changed, passed=not Changed))
	assert not Changed
