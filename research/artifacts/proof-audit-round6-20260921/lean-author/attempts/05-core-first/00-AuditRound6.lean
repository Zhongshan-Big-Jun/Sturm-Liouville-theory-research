...
polynomial derivatives and evaluation at +/-1. No Sobolev, spectral, complex
...
theorem trace_matrix_det : trace_matrix.det = 15360 := by
  norm_num [trace_matrix, Matrix.det_succ_row_zero, Matrix.det_fin_three,
...
theorem cancellation_formula :
  ...
  norm_num [cancellation, p_even, smul_eq_C_mul]
  ring
