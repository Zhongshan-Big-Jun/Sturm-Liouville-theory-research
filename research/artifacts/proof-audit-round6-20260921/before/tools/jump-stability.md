---
{"author_ids": ["01a06f46-dd03-7c83-9267-32048412c359", "coordinator-20260920-round3"], "created": "2026-08-05", "evidence_status": "ANALYTIC_PROOF_SCOPED; REVIEW_BINDING_RENEWED", "scope": "Both parity recurrences; product equality only for B=Bprime=0; formal polynomial images distinguished from Krein domain.", "source": "自研 (会话 11, 方向 3)", "sources": [{"locator": "Unchanged third-round general recurrence, exact model and perturbation proof", "path": "docs/SL_stability_moment_jump.tex", "sha256": "f77079f053c7d22a03ae5dffc38f092fb9b532c92345256582a96d2d41f03c45"}], "status": "第三轮解析修订; 可复用状态见纠错记录", "tags": ["mathtool", "self-developed", "completeness", "moments", "stability"], "title": "矩跳跃的条件稳定性: 实际递推与 B=0 模型", "tool_id": "jump-stability"}
---
# 矩跳跃的条件稳定性
...
原 Krein 稀疏族的 0<=s<=3 结果和 3<s<7/2 未判定窗口另行登记, 不由本卡的一般空间假设直接推出. 本卡保留一般非对角可表示性及变系数算子的研究边界.
