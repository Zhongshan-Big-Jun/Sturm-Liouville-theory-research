...
SOURCE = Path('/mnt/f/LaTeX/BVE research/lean-proof/SL/AuditRound4.lean')
...
Names = ['SL.AuditRound4.' + Name for _, Name in Entries]
...
'''
(OUT / 'InspectAuditRound4.lean').write_text(Probe)
(OUT / 'inspection-targets.json').write_text(json.dumps({
	...
	'entries': [{'kind': Kind, 'name': 'SL.AuditRound4.' + Name} for Kind, Name in Entries]
}, indent=2) + '\n')
