...
title: "半问题 Green 与惯性: 对称支上的定性充分判据与奇偶性边界"
tags: [mathtool, self-developed, green-function, inertia, oscillation, gap-extremals, nge2]
source: 自研 (R-205 历史记录; 第七轮修订入口 docs/SL_gap_nge2_symmetry_local_proof.tex 与 reports/proof-audit-round7-20260921/REPORT.md)
status: 第七轮作者候选, 待独立审查; Green 表达式服务于更强定性判据, 不与 bare G1' 等价; 有限点核惯性强化等式及历史全局结论未获本轮认证
created: 2026-08-13
updated: 2026-09-21
---
