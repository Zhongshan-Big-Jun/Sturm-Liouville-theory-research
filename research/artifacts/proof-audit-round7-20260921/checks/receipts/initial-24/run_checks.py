...
def main():
	...
	for Label, Payload, Flag in (('normal', Normal, 0), ('optimized', Optimized, 1)):
		...
		require(Payload['passed_groups'] == Payload['total_groups'] == 24, Label + ' complete group count')
	...
	print('24/24 in both modes; details identical; both wrong-formula processes rejected.', flush=True)
