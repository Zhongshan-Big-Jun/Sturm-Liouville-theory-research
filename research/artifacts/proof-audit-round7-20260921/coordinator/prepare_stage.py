...
Root=Path('/mnt/f/LaTeX/BVE research');Out=Path('/mnt/f/tools/math-audit-round7-20260921');Base=json.loads((Out/'baseline.json').read_text())
...
for Prefix in ['reports/proof-audit-round7-20260921','research/artifacts/proof-audit-round7-20260921','research/library']:
	for P in (Root/Prefix).rglob('*'):
		...
		Paths.add(Name)
Paths.update(['lean-proof/SL/AuditRound7.lean','scripts/.gitattributes','docs/.gitattributes','lean-proof/SL/.gitattributes','tools/.gitattributes'])
