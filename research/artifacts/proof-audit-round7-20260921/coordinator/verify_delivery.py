...
OUT = Path('/mnt/f/tools/math-audit-round7-20260921')
...
result = {
    ...
    'report': 'reports/proof-audit-round7-20260921/REPORT.md',
    'formalization_scope': 'Local trigonometric Wronskian identities/negativity, endpoint coefficient algebra and conditional scalar FH mirror combination; not Volterra/minmax/Taylor remainder or spectral differentiability',
