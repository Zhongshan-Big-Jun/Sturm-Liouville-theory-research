...
if Mode=='dispatch':
	...
	Completion=json.loads((Out/(Name+'-review-completion.json')).read_text())
	assert Completion['tool']=='multi_agent_v1__wait_agent'
	Result=Review.receive_review(Root,Dispatch['bundle'],Completion['result'])
