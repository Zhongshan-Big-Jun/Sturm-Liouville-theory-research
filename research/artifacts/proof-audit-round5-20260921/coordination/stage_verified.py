...
assert subprocess.check_output(['git','rev-parse','HEAD'],cwd=Root,text=True).strip()=='c0b36b90004cffb0552c9fa9f229e1f7cec8a706'
...
Check={'status':'PASS','staged_paths':len(Paths),'actual_git_blobs_match_worktree_sha256':True,'scope':'Exact allowlist only; ignored raw execution logs were force-added by individual path. No unrelated baseline changes staged.'}
