...
theorem monomial_odd_residues (k : ℕ) :
  ...
  rw [residues_apply, derivative_X_pow]
  simp only [eval_mul, eval_C, eval_pow, eval_X, one_pow, mul_one, he]
  norm_num [pow_add, pow_mul] <;> constructor <;> ring
