# -*- coding: utf-8 -*-
"""Symbolic verification: 16*Delta^4 * J2_2d == NJ2 (as rational identity in six variables)."""
import sympy as sp
import json
...
print('J computed, now comparing 16*Delta^4*J with NJ2 ...')
# NJ2 from json
