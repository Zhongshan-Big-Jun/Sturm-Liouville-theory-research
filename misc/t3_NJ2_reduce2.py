# -*- coding: utf-8 -*-
"""t3_NJ2_reduce2.py: reduce NJ2 modulo circle relations, print grouped form."""
...
# reduce modulo sg^2+cg^2-1, st^2+ct^2-1 (use a groebner-ish reduction via sympy reduced)
G = [sg**2 + cg**2 - 1, st**2 + ct**2 - 1]
red, _ = sp.reduced(sp.expand(NJ2), G, [sg, cg, st, ct])
red = sp.expand(red)
