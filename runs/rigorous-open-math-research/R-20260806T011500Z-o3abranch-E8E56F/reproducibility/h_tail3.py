# -*- coding: utf-8 -*-
"""h_tail3.py: optimized tail scan using continuation + grid FD for h'."""
...
json.dump(results, open(r"F:\LaTeX\BVE research\runs\rigorous-open-math-research\R-20260806T011500Z-o3abranch-E8E56F\reproducibility\h_tail3.json","w"), indent=1)
