...
if __name__ == '__main__':
    ...
    allok &= run('cert_c4_boxes.json', reeval_c4, '0.897597901025655210972033336078616704034170566267291310427109', '1.25559265358979323846264338327950288419716939937510582097494', 0, 0, False, dim2=False)
