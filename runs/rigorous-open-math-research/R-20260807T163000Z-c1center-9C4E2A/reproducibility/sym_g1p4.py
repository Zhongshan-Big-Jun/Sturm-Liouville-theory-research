# -*- coding: utf-8 -*-
"""sym_g1p4.py: exact partials of R1/R2 evaluated on the branch, fast.
Roots found by numpy scan, refined by mpmath Newton; partials via
sympy-lambdify chain rule (secular IFT)."""
