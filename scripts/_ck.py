...
ck = """# Checkpoint: C1 next attack + INF limit dispatched (2026-08-06T20:50Z)
...
"""
with io.open(root + r"\state\checkpoints\2026-08-06T205000Z--c1b-inflimit-dispatch.md", "w", encoding="utf-8", newline="\n") as f:
    f.write(ck)
