...
- [[lamplighter-range-translation-tv]] - Lamplighter range-triple 平移 TV: 对数上界, one-sided 界, killed-kernel 与 coarea 归约 (pilot v5 Arm A, 2026-08-26)
...
| [[lamplighter-range-translation-tv]] | 自研 (pilot v5 Arm A, 2026-08-26) | STRICT partial: 1/(4sqrt(t)) 下界, (2log(t)+15)/sqrt(t) 上界, one-sided 12/sqrt(t), killed-kernel/coarea; 常数阶 joint 上界 OPEN | 自研方法 |
